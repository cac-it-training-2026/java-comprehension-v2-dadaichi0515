...
class Member {
	...
	public static Member getInsyance(int id, String password, String name, int age, int rank) {
		Member member = new Member(id, password, name, age, rank);

		Coupon coupon1 = Coupon.getInstamce(1, 0.5, "最初の特典");
		Coupon coupon2 = Coupon.getInstamce(2, 0.25, "今月の特典");
